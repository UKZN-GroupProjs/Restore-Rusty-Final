...
* Press the **Play ▶️** button in the Unity Editor to start playing.

---

### ⚙️ Blender Requirement

Some assets in this project were created from first principles and are provided as `.blend` files. **Blender must be installed** to view, edit, or export these assets. Download Blender from [blender.org](https://www.blender.org/download/).
...
We **do not claim ownership** or usage rights for any **unauthorized copyrighted material**.
All assets, visuals, or references that resemble existing works are included **strictly for academic demonstration and non-commercial use**.
...
### 🧰 Help Rusty find his missing parts and restore what was once lost!
